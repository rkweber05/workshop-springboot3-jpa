...
public class TestConfig implements CommandLineRunner{ // classe para instanciar o banco de dados
	...
	public void run(String... args) throws Exception { //executrado quando a aplicação for iniciada
		...
		User u2 = new User(null, "Alex Green", "alex@gmail.com", "9s77777777", "123456");
		...
		o1.setPayment(pay1); // associei meu order1 com o meu payment1
		orderRepository.save(o1); // depois de associar, salvar no banco 
	}
